...
#######################################################################
############ Remove All Non Admin Accounts Admin Rights ###############
########## Created by Ben Carter & Phil Walker August 2017 ############
#######################################################################
...
function removeLDAndScript() {
  #Remove the launchD plist and remove admin script
  if [ -f /Library/LaunchDaemons/com.bauer.tempadmin.plist ]; then
    rm /Library/LaunchDaemons/com.bauer.tempadmin.plist
    echo "LaunchDaemon deleted"
  fi
